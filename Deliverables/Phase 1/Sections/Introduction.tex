...
The rest of this document is structured according to the defined METHONTOLOGY steps, representing the \mintedInline{Documentation} process. First, the ontology specification%
...
% , followed by the initial step of creating a specification document.%
Conceptualisation%
