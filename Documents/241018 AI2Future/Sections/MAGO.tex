...
\begin{frame}{\insertsection}
    \customFigure[1]{% how wide is the figure?
        \input{Documents/241018 AI2Future/Figures/research structure overview}
...
\begin{frame}{\insertsubsection}
    \customFigure[1]{
        \includegraphics{Documents/241018 AI2Future/Figures/onto.png}
...
\begin{frame}{\insertsubsection}
    \customFigure[0.6]{
        \includegraphics{Documents/241018 AI2Future/Figures/Translation documents.png}
    }{Essential files of the translation process}{translation files}
\end{frame}

\begin{frame}{\insertsubsection}
    \customFigure[1]{
        \includegraphics{Documents/241018 AI2Future/Figures/Behaviour Individuals.png}
...
\begin{frame}{\insertsubsection}
    \customFigure[0.6]{
        \includegraphics{Documents/241018 AI2Future/Figures/Generated template files.png}
...
\begin{frame}{\insertsubsection}
    \customFigure[1]{
        \includegraphics{Documents/241018 AI2Future/Figures/Agent available knowledge.png}
