...
\begin{frame}[fragile]{\insertsection}
    ...
    \begin{multicols}{3}
        \begin{listing}
        \mintedFileText[firstline=7, lastline=18]{Documents/241119 DSC Europe/Implementation/ontology turtle.txt}
        \end{listing}

        \columnbreak
        
        \begin{listing}
        \mintedFileText[firstline=20,lastline=31]{Documents/241119 DSC Europe/Implementation/ontology turtle.txt}
        \end{listing}

        \columnbreak
        
        \begin{listing}
        \mintedFileText[firstline=33,lastline=46]{Documents/241119 DSC Europe/Implementation/ontology turtle.txt}
        \end{listing}
    \end{multicols}
    \endgroup
...
\begin{frame}[fragile]{\insertsection}
    ...
    \begin{multicols}{2}
        ...
        \begin{listing}
        \mintedFileText[]{Documents/241119 DSC Europe/Implementation/ontology prolog.P}
        \end{listing}
    \end{multicols}
    \endgroup
