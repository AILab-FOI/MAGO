...
\begin{frame}[fragile]{\insertsection}
    ...
    \begin{multicols}{3}
        \begin{listing}
        \mintedFileText[firstline=7, lastline=18]{Documents/241119 DSC Europe/Implementation/ontology example.txt}
        \end{listing}

        \columnbreak
        
        \begin{listing}
        \mintedFileText[firstline=20,lastline=31]{Documents/241119 DSC Europe/Implementation/ontology example.txt}
        \end{listing}

        \columnbreak
        
        \begin{listing}
        \mintedFileText[firstline=33,lastline=46]{Documents/241119 DSC Europe/Implementation/ontology example.txt}
        \end{listing}
    \end{multicols}
    \endgroup
