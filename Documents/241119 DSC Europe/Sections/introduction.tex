...
\begin{frame}
    \begin{multicols}{2}
        ...
        \qrcode[height=0.42\linewidth]{https://github.com/AILab-FOI/MAGO/tree/main/Documents/241119\%20DSC\%20Europe}
    \end{multicols}
\end{frame}
...
\begin{frame}{\insertsection}
    ...
    \begin{multicols}{3}
        ...
        \medskip\qrcode[height=7em]{https://croris.hr/crosbi/searchByContext/2/34294?VRSTA\_RAD=6\&VRSTA\_RAD=5\&VRSTA\_RAD=4\&VRSTA\_RAD=3\&VRSTA\_RAD=7}

        \columnbreak
        
        Project activity

        \medskip\qrcode[height=7em]{https://projects.foi.hr/portfolio/dokresa/en}

        \columnbreak
        
        BSc and MA Mentees

        \medskip\qrcode[height=7em]{https://www.croris.hr/crosbi/searchByContext/2/34294?VRSTA\_RAD=8}
    \end{multicols}
\end{frame}